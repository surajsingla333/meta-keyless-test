...
const onboardSafleButton = document.getElementById('connectSafleButton');
...
const initialize = async () => {
  try {
    ...
    // const portis = new Portis('e77819b5-236a-4a43-b63a-b2f6051c304a', 'mainnet');
    // portis.showPortis();
    // ethersProvider = new ethers.providers.Web3Provider(portis.provider, 'any');
    ethersProvider = new ethers.providers.Web3Provider(windows.ethereum, 'any');
    // console.log({ portis }, "here")
    // ethersProvider.getSigner()
    // console.log("SIGNERs", ethersProvider.getSigner(),)
  ...
  const onClickConnect = async () => {
    ...
    try {
      console.log({ ethereum }, "ON CLICK")


      // const portis2 = new Portis('e77819b5-236a-4a43-b63a-b2f6051c304a', 'mainnet');
      // let ethersProvider2 = new ethers.providers.Web3Provider(portis2.provider, 'any');
  ...
  // { console.log("APLE") }
  const onClickSafleConnect = async () => {
    console.log("APLE")

    // console.log({ getNetworks, KeylessWeb3 })
  ...
  const updateButtons = () => {
    ...
    onboardSafleButton.onclick = onClickSafleConnect;
